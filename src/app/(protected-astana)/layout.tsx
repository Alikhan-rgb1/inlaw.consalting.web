...
export default async function ProtectedAstanaLayout({ children }: { children: ReactNode }) {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-18">
                        <div className="flex items-center gap-8">
                            <Link href="/astana/dashboard" className="flex items-center gap-3 group">
                                <div className="relative overflow-hidden rounded-full shadow-sm border border-slate-100 group-hover:shadow-md transition-all duration-300 w-10 h-10">
                                    <Image
                                        src="/logo.png"
                                        alt="Inlaw.kz Logo"
                                        fill
                                ...
                                <div className="flex flex-col justify-center">
                                    ...
                                    <span className="font-bold text-slate-900 leading-none tracking-tight transition-all duration-300 text-lg">
                                        INLAW inc LTD. <span className="text-indigo-600">· Astana</span>
                                    </span>
                                </div>
                            </Link>
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <LogoutButton callbackUrl="/astana" />
                        </div>
                    </div>
                </div>
            </nav>
