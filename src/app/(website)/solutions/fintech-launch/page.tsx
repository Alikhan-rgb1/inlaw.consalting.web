...
export default function FintechLaunchPage() {
  ...
  const whyInlaw = fintech.whyInlawItems || [];
  const jurisdictions = fintech.jurisdictions || [];
  const processSteps = fintech.processSteps || [];
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans text-slate-900">
      ...
      {/* 5. WHY FINTECH LAUNCH WITH INLAW */}
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">{fintech.whyJurisdictionTitle}</h2>
            <p className="text-lg text-slate-600">
              {fintech.whyJurisdictionDescription}
            </p>
          </motion.div>
      ...
      {/* 6. JURISDICTIONS AND REGULATION */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            {fintech.jurisdictionsTitle}
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-lg text-slate-600 text-center max-w-3xl mx-auto mb-12"
          >
            {fintech.jurisdictionsDesc}
          </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {jurisdictions.map((item, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="flex items-center gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100 justify-center text-center"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#2E447A] rounded-3xl p-8 md:p-12 text-white shadow-2xl overflow-hidden relative">
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold mb-8">{fintech.timeline?.title}</h2>
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-blue-200 text-sm">{fintech.timeline?.registrationLabel}</p>
                      <p className="text-xl font-bold">{fintech.timeline?.registrationValue}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      <p className="text-blue-200 text-sm">{fintech.timeline?.licenseLabel}</p>
                      <p className="text-xl font-bold">{fintech.timeline?.licenseValue}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      <p className="text-blue-200 text-sm">{fintech.timeline?.bankLabel}</p>
                      <p className="text-xl font-bold">{fintech.timeline?.bankValue}</p>
                    </div>
                  </div>
                </div>
              </div>
