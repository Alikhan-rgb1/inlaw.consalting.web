...
export default function AstanaRegisterPage() {
  ...
  const translations = {
    EN: {
      ...
      subtitle: 'Create your Astana Office (AIFC) portal account',
    ...
    RU: {
      ...
      subtitle: 'Создайте аккаунт в портале офиса Астаны (AIFC)',
    ...
    CHI: {
      title: '客户注册',
      subtitle: '创建您的阿斯塔纳办事处（AIFC）门户账户',
      companyName: '公司名称',
      fullName: '全名',
      email: '电子邮件',
      phone: '电话',
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6 text-center">
             <Link href="/astana" className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
               {t.alreadyAccount}
             </Link>
          </div>
        </div>
