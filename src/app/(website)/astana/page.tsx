...
export default function AstanaLoginPage() {
  ...
  const translations = {
    EN: {
      title: 'Astana Office Portal',
      subtitle: 'Secure Client Access — AIFC',
      email: 'Email address',
      password: 'Password',
      signIn: 'Sign in',
    ...
    RU: {
      title: 'Портал офиса в Астане',
      subtitle: 'Безопасный вход для клиентов — AIFC',
      email: 'Email адрес',
      password: 'Пароль',
      signIn: 'Войти',
      signingIn: 'Вход...',
